    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-24 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Service Not Found</h1>
          <p className="text-muted-foreground mb-6">The service you’re looking for does not exist.</p>
          <Button asChild>
              ...
              {!!highlights.length && (
                <motion.div variants={fadeUp} className="mt-6 flex flex-wrap gap-3">
                  {highlights.map((h: string, i: number) => (
                    <span key={i} className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm bg-primary/10 text-foreground">
      ...
      {!!projects.length && (
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            >
              <div>
                <h2 className="text-3xl md:text-4xl font-bold">Projects in {service.title}</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {!!benefits.length && (
                <motion.div
                  ...
                  viewport={{ once: true, amount: 0.3 }}
                >
                  <motion.h3 variants={fadeUp} className="text-2xl font-bold mb-4">
                    Why This Service
                  </motion.h3>
