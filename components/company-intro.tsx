        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              Since 2009, Shravan Electrical Contractor has delivered high-quality
              H.T. and L.T. electrical works, sheet metal fabrication, and consultancy
              services in Nanded. With a turnover of ₹25-100 Cr, we serve MSEDCL,
              PWD, and private clients with precision and reliability.
            </p>
