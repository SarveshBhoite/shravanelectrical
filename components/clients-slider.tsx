...
const clients = [
  { name: "Tata Group", logo: "/tata-group-logo.jpg" },
  { name: "Reliance Industries", logo: "/reliance-industries-logo.jpg" },
  { name: "Adani Group", logo: "/adani-group-logo.jpg" },
  { name: "Larsen & Toubro", logo: "/letter-L-nature.png" },
  { name: "NTPC", logo: "/ntpc-logo.jpg" },
  { name: "Indian Railways", logo: "/indian-railways-logo.jpg" },
  { name: "BHEL", logo: "/bhel-logo.jpg" },
  { name: "ONGC", logo: "/ongc-logo.jpg" },
  { name: "Power Grid", logo: "/power-grid-corporation-logo.jpg" },
  { name: "NHAI", logo: "/placeholder.svg?height=100&width=200" },
]
...
export function ClientsSlider() {
  ...
  return (
    <section id="clients" ref={sectionRef} className="py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
      {/* Animated background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Partnering with India's most prestigious organizations to deliver excellence
          </p>
        </div>
        ...
        <div className="relative">
          <div className="overflow-hidden">
            <div
              ...
              style={{
                width: `${doubledClients.length * 250}px`,
              }}
            >
          ...
          {[
            ...
            >
              <div className="text-4xl md:text-5xl font-bold text-white mb-2">
                <Counter end={stat.value} suffix={stat.suffix} isInView={isInView} className="text-4xl md:text-5xl font-bold text-white" />
              </div>
